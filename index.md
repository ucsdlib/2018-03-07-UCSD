...
helper: ["Rick McCosh (Medicine), Annelise Sklar (Library), Bia Villas Boas(SIO), Katherine Wang(Library)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
